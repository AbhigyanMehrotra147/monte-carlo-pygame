...
beer_formula_surface_size = (0.8,0.6)
...
class DepictBox:
    ...
    def _render_lines(self):
        ...
        pygame.draw.line(surface=self._surface, color=self._h_line_color,
                         start_pos=self._h_line_start, end_pos=self._h_line_end, width=self._h_line_width)
        pygame.draw.line(surface=self._surface, color=self._v_line_color,
                         start_pos=self._v_line_start, end_pos=self._v_line_end, width=self._v_line_width)
